...
import Booking from "../Navbar/Bookingdialog";
        ...
        <div className="mx-auto max-w-5xl pt-16 sm:pt-40 sm:pb-24">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-75px md:4px">
              <span className="text-[#611f69]">#Best </span> Services at Your{" "}
              <br /> Doorstep
            </h1>
            <p className="py-11 text-lg leading-8 text-black">
              Our cleaning services are the best-in-class and come at a very low
              cost.
            </p>
