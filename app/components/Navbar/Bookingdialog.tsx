                    ...
                    <div className="w-full max-w-md space-y-8">
                      <div>
                        {/* <img
                          ...
                          alt="Your Company"
                        /> */}
                        <h1 className="text-2xl text-center font-black pb-4">
                          Prabha Cleaning Works
                        </h1>
                        <h2 className="mt-6 text-center text-xl font-bold tracking-tight text-[#611f69]">
                          To book our services, you can contact us either by
                          phone or by emailing us.
                        </h2>
                      </div>
                      ...
                      <ul className="mt-12 flex flex-wrap gap-x-12 gap-y-6 items-center lg:gap-x-24">
                        <li>
                          ...
                          <div className="mt-3 flex items-center gap-x-3">
                            ...
                            <a href="tel:+917200747649" className="text-black">
                              Phone : +91 - 7200747649
                            </a>
                          </div>
                        </li>
